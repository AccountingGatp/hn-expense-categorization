!(function (e) {
  ...
  const r = {
    date: "date",
    "cc account": "ccAccount",
    "payment account": "ccAccount",
    bank: "ccAccount",
    payee: "payee",
    account: "account",
    ...
    buildWorkbook: function (e, o, i) {
          ...
          width:
            "description" === t
              ...
              : "memo" === t
                ...
                : "account" === t
                  ? 26
                  : "cc account" === t || "payment account" === t || "bank" === t
                    ? 24
                  : "payee" === t
                    ? 24
                    : "class" === t
      ...
      return (
        [
          ...
          "    categorized via the Master COA / Class / Vendor lists. The selected bank/credit-card account is",
          "    written to CC Account on every QBO row; Payee, Account and Class remain independently categorized.",
          "    Payee, Account and Class cells carry a data-entry dropdown for quick manual correction.",
